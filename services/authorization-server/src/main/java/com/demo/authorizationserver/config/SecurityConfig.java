package com.demo.authorizationserver.config;
...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(){
        var registerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("api-client")
                .clientSecret("secret")  // this value will be secured in secret manager
                .scope(OidcScopes.OPENID)
                .scope(OidcScopes.PROFILE)
                .redirectUri("http://127.0.0.1:4200/login/oauth2/code/api-client")
